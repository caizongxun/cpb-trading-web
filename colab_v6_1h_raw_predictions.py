...
# Display
print(f"\n{'='*80}")
print(f"\n[Step 6] Displaying V6 1H charts (Raw Predictions)...\n")
...
print(f"\nKey Features:")
print(f"  ✅ V6 Model (not V5)")
print(f"  ✅ Raw model predictions (no smoothing)")
print(f"  ✅ More volatile - realistic for trading")
print(f"  ✅ Practical use case")
print(f"\nFile naming:")
print(f"  Output: v6_1h_raw_{{SYMBOL}}_{{timestamp}}.png")
print(f"  Models: {{SYMBOL}}_1h_model.h5 (from models_v6/)")
print(f"  Scalers: {{SYMBOL}}_1h_scalers.pkl (from models_v6/)")
print(f"{'='*80}\n")
